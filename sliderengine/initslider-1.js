jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,slice,blocks,elastic,threedflipwithzoom,threedwithzoom,threedflip,cssslide,threedtiles,slide,crossfade,kenburns,threedhorizontalwithzoom,fade,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
